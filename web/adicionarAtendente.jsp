...
<section id="meio">
    ...
    <aside id="conteudo">
        <h4><a href="root.jsp">início</a> > <a href="#">cadastro de atendente</a></h4>
        <form action="Atendente?action=cadastrar" method="post">
            <table>
                <tr>
               ...
               <!-- <tr>
                ...
                <tr>
                    <td>Código:</td>
                    <td><input id="codigoAtendente" name="codigoAtendente" type="text" maxlength="5" required/></td>                 
                </tr>
                <tr>

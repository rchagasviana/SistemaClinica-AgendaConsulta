...
<section id="meio">
    ...
    <aside id="conteudo">
        <h4><a href="atendente.jsp">início</a> > <a href="#">cadastro de paciente</a></h4>
        <form action="Paciente?action=cadastrar" method="post">
            <table>
                <tr>
               ...
               <!-- <tr>
                ...
                <tr>
                    <td>Código:</td>
                    <td><input id="codigoAtendente" name="codigoPaciente" type="text" maxlength="5" required/></td>                 
                </tr>
